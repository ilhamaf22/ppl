    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
          <div id="dropdown-riset" data-toggle="dropdown" class="row d-flex align-items-center">
            <h1 class="navbar-nav mr-2 judul-dashboard" style="font-size: 1.8em;">Dashboard Riset 1</h1>
            ...
            <ul class="position-absolute dropdown-menu dropdown-menu-md dropdown-menu-right">
              <a href="/riset/1/dashboard" class="dropdown-item">Halaman Riset 1</a>
              <a href="/riset/2/dashboard" class="dropdown-item">Dashboard Riset 2</a>
