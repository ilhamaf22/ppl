    ...
    <div class="sidebar mt-4">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/riset/1/dashboard" class="nav-link <?= $menuActive == 'Home' ? 'active' : ''; ?>">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/riset/1/dashboard/kajian1" class="nav-link <?= $subMenuActive == 'Kajian 1' ? 'active' : ''; ?>">
                  <!-- <i class="far fa-circle nav-icon" style="margin-left:15px; font-size:15px;"></i> -->
                  <p style="margin-left:25px;">Kajian 1</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/riset/1/dashboard/kajian2" class="nav-link">
                  <!-- <i class="far fa-circle nav-icon" style="margin-left:15px; font-size:15px;"></i> -->
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/riset/1/dashboard/peta1" class="nav-link <?= $subMenuActive == 'Peta 1' ? 'active' : ''; ?>">
                  <!-- <i class="far fa-circle nav-icon" style="margin-left:15px; font-size:15px;"></i> -->
                  <p style="margin-left:25px;">Peta 1</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/riset/1/dashboard/peta2" class="nav-link <?= $subMenuActive == 'Peta 2' ? 'active' : ''; ?>">
                  <!-- <i class="far fa-circle nav-icon" style="margin-left:15px; font-size:15px;"></i> -->
          ...
          <li class="nav-item">
            <a href="/riset/1/dashboard/tabeldinamis" class="nav-link <?= $menuActive == 'Tabel Dinamis' ? 'active' : ''; ?>">
          ...
          <li class="nav-item">
            <a href="/riset/1" class="nav-link <?= $menuActive == 'Tentang Riset 1' ? 'active' : ''; ?>">
